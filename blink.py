    ...
    def run(self):
        ...
        while True:
            ...
            if blinkShouldBeOn and not blinkIsOn:
                os.system('paplay /usr/share/sounds/ubuntu/notifications/Positive.ogg')
                os.system('blink1-tool --green --blink 2 ; blink1-tool --green')
                blinkIsOn = True
...
def handle_line(line):
    global blinkShouldBeOn, threadLock
